...
import com.tolgaduran.moviedb.activity.BaseActivity;
import com.tolgaduran.moviedb.adapter.TVMovieArrayAdapter;
import com.tolgaduran.moviedb.asyntask.FetchTVMovieTask;
import com.tolgaduran.moviedb.data.MovieContract;
import com.tolgaduran.moviedb.model.MovieInfo;
import com.tolgaduran.moviedb.utils.AppRate;
...
public class MainActivityFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>, AsyncResponse {
    ...
    public void loadArguments() {
        ...
        if (MODE != null) {
            switch (MODE) {
                case BaseActivity.FRAGMENT_TAG_MOVIE_BOOKMARKS:
                    isMovieBookmark = true;
                    isTVBookmark = false;
                    isMovie = true;
                    break;
                case BaseActivity.FRAGMENT_TAG_TV_BOOKMARKS:
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listAdapter =
                new TVMovieArrayAdapter(
                        getActivity(), isMovie, isMovieBookmark, isTVBookmark, null, 0);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if (cursor != null) {
                    ...
                    ((Callback) getActivity())
                            .onItemSelected(cursor.getString(isTVBookmark ? Constants.TV_DETAILS_COL_TV_ID : (isMovieBookmark ? Constants.MOV_DETAILS_COL_MOVIE_ID : (isMovie ? Constants.MOV_COL_MOVIE_ID : Constants.TV_COL_TV_ID))), imageView, current, isMovie);
                }
                mPosition = position;
            }
        });
